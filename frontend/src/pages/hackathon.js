...
const HackathonContractAddress = "0x13284345c730b6051b28821a8be38df6a24d5fba" // Mumbai
    ...
    return (
        <div style={overallGrid}>
            ...
            <div style={rowStyle}>
                ...
                <Sticker
                title="Tiago"
                content="hello, I'd like to chat about ..."
                smallText="100"
                key="1"
                />
            </div>
...
const SubmitSubpage = () => {
    ...
    const submit = async () => {
        ...
        HackathonContract.methods.submission(walletAddress, name).send({from: walletAddress}).on('receipt', function(){
            setSubmitted(true)
        });
    }
    ...
    return (
        <div>
            ...
            {
                submitted ?
                <button onClick={submit} style={submitButtonStyle}>Claim POAP!</button>
                :
    ...
    return (
        <div style={overallGrid}>
            ...
            <div style={rowStyle}>
                <Project
                    title="Pasteis"
                    content="Digital Home for Hackathons!"
                ...
                <Project
                    title="Climate NFT"
                    content="Help cool down the planet!"
                    smallText="team 0xf45f"
                    key="2"
                    vote={vote}
                />
                <Project
                    title="DAO Voter"
                    content="A voting tool for DAOs"
                    smallText="team 0x42ab"
                    key="2"
                    vote={vote}
                />
                <Project
                    title="IPFS Cloud Photo"
                    content="A mobile app for photo sharing"
                    smallText="team 0x5a21"
                    key="2"
                    vote={vote}
                />
            </div>
